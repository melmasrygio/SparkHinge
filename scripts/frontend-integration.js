 ...
 * This file demonstrates how to integrate Sparkhinge with a web frontend
 */

// For React/Vue/Angular applications
export class SparkhingeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SparkhingeClient(provider, contractAddress);
